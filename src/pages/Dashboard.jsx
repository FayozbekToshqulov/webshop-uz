    ...
    return (
        ...
        <div>
            ...
            {show1 ? (
                ...
                <button className="mt-5 flex max-w-[100%] m-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded mb-5" onClick={showModal}>New Product</button>
            )}
