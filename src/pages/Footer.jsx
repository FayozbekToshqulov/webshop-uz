                ...
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    ...
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">Stev Jobs book</a>
                                </li>
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">Programmersk</a>
                                </li>
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">JavaScript book</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">Accessories for phone</a>
                                </li>
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">For children</a>
                                </li>
