    ...
    return (
        ...
        <div>
            ...
            {show1 ? (
                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <div className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2  m-auto">
                                ...
                                <br /><br />
                                <button className="text-white ml-1   bg-red-500 border-0 py-2 px-6 text-lg focus:outline-non" onClick={closeModal}>Close</button>
                ...
                <button className="mt-5 flex max-w-[100%] m-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded mb-5" onClick={showModal}>New Clients</button>
            )}
